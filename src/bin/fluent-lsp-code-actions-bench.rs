...
use fluent_lsp::benchmark_code_actions_at_cursor;
use serde_json::json;
use tempfile::TempDir;
use tower_lsp::ls_types::Position;
...
fn main() {
    ...
    for iteration in 0..args.repeats {
        ...
        let summary = benchmark_code_actions_at_cursor(
            &origin_source,
            &translation_source,
            &translation,
            position,
    ...
    let summary = last_summary.expect("bench should run");
    let result = json!({
        "shape": {
        ...
        "summary": {
            ...
            "missing_entries_action_count": summary.missing_entries_action_count,
            "single_message_copy_action_count": summary.single_message_copy_action_count,
            "generate_selector_action_count": summary.generate_selector_action_count,
            "rewrite_selector_action_count": summary.rewrite_selector_action_count,
            "missing_entries_ms": summary.missing_entries_ms,
            "generate_selector_ms": summary.generate_selector_ms,
            "rewrite_selector_ms": summary.rewrite_selector_ms,
